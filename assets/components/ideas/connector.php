<?php
if (file_exists(dirname(dirname(dirname(dirname(__FILE__)))) . '/config.mdxcr.php')) {
    /** @noinspection PhpIncludeInspection */
    require_once dirname(dirname(dirname(dirname(__FILE__)))) . '/config.mdxcr.php';
} else {
    require_once dirname(dirname(dirname(dirname(dirname(__FILE__))))) . '/config.mdxcr.php';
}
/** @noinspection PhpIncludeInspection */
